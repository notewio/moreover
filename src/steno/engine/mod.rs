/*
    Struct to represent the steno engine.
    Process strokes and return output in the form of actions.
*/

mod dictionary;

use super::{diff, output::translations_to_actions, steno_to_id, Action, Translation};
use dictionary::*;
